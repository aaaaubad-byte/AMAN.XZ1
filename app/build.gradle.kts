...
android {
    ...
    defaultConfig {
        ...
        // Safe configuration loading: reads local.properties or environment variables
    ...
    buildTypes {
        release {
            ...
            signingConfig = signingConfigs.getByName("debug") // For debug/testing release build
        }
        debug {
