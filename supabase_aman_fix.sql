...
-- =============================================================
-- AMAN - Supabase migration aligned with current Android app contract
-- =============================================================
...
-- =============================================================
-- helper: detect provider by prefix
-- =============================================================
...
BEGIN
    ...
    VALUES (
        p_name, upper(p_code), p_phone_length, p_is_active, p_is_visible_to_customers, p_display_order
    )
...
BEGIN
    ...
    VALUES (
        p_provider_id, p_name, p_price, p_duration_days, p_is_active, p_is_visible_to_customers
    )
    RETURNING * INTO v_row;
...
BEGIN
    ...
    VALUES (
        p_name, p_account_number, p_account_owner_name, p_payment_instructions, p_is_active
    )
    RETURNING * INTO v_row;
...
-- =============================================================
-- Enable Row Level Security for tables where needed
-- =============================================================
...
-- =============================================================
-- Fix remaining live-database contract mismatches
-- =============================================================
